...
eel.expose(progress_abgerufene_personen)
function progress_abgerufene_personen(info_python){
...
eel.expose(progress_freigegebene_prüfungen);
function progress_freigegebene_prüfungen(info_python){
...
eel.expose(progress_abgerufene_personen_zurückziehen);
function progress_abgerufene_personen_zurückziehen(info_python){
...
eel.expose(progress_zurückgezogene_prüfungen);
function progress_zurückgezogene_prüfungen(info_python){
